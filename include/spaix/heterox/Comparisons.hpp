...
struct Comparisons {
  ...
  static constexpr bool contains(const Box& lhs, const Point<Ts...>& rhs)
  {
    return detail::contains_rec(lhs, rhs, rhs.ibegin());
  }

  static constexpr bool contains(const Box& lhs, const Rect<Ts...>& rhs)
  {
    return detail::contains_rec(lhs, rhs, rhs.ibegin());
  }

  static constexpr bool intersects(const Box& lhs, const Point<Ts...>& rhs)
  {
    return detail::intersects_rec(lhs, rhs, rhs.ibegin());
  }

  static constexpr bool intersects(const Box& lhs, const Rect<Ts...>& rhs)
  {
    return detail::intersects_rec(lhs, rhs, rhs.ibegin());
  }
};
